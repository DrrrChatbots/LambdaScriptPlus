...
// true                                     { this.yylval = true; if(this.opt_t) console.log(`<keyword ${yytext}>`); return yytext; }
// false                                    { this.yylval = false; if(this.opt_t) console.log(`<keyword ${yytext}>`); return yytext; }
// while                                    { this.yylval = ''; if(this.opt_t) console.log(`<keyword ${yytext}>`); return yytext; }
...
// null                                     { this.yylval = null; if(this.opt_t) console.log(`<keyword ${yytext}>`); return yytext; }
// undefined                                     { this.yylval = undefined; if(this.opt_t) console.log(`<keyword ${yytext}>`); return yytext; }
